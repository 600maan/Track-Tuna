...
/* Define Custom Asset structure, with 4 properties.  
Structure tags are used by encoding/json library
*/
...
func (s *SmartContract) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	} else if function == "initCustomAsset" {
		return s.initCustomAsset(APIstub)
...
/*
 * The initCustomAsset method *
Will add test data to our network
 */
 func (s *SmartContract) initCustomAsset(APIstub shim.ChaincodeStubInterface) sc.Response {
	customAssest := []CustomAsset{
		CustomAsset{AssetID: "I001", AssetName: "JPY", AssetDescription: "Japanese Yen", AssetAmount: "1500"},
		CustomAsset{AssetID: "I002", AssetName: "HKD", AssetDescription: "HongKong Dollar", AssetAmount: "2500"},
		CustomAsset{AssetID: "I003", AssetName: "USD", AssetDescription: "US Dollar", AssetAmount: "5000"},
		CustomAsset{AssetID: "I004", AssetName: "RMB", AssetDescription: "Chinese Reminibi", AssetAmount: "600"},
		CustomAsset{AssetID: "I005", AssetName: "INR", AssetDescription: "Indian Rupees", AssetAmount: "1100"},
		CustomAsset{AssetID: "I006", AssetName: "NRS", AssetDescription: "Nepali Rupees", AssetAmount: "4500"},
		CustomAsset{AssetID: "I007", AssetName: "BTC", AssetDescription: "Bitcoin", AssetAmount: "5600"},
		CustomAsset{AssetID: "I008", AssetName: "ETH", AssetDescription: "Ethereum", AssetAmount: "300"},
		CustomAsset{AssetID: "I009", AssetName: "LTC", AssetDescription: "LiteCoin", AssetAmount: "4000"},
		CustomAsset{AssetID: "I010", AssetName: "CAD", AssetDescription: "Canadian Dollar", AssetAmount: "3000"},
	}

	i := 0
	for i < len(customAssest) {
		fmt.Println("i is ", i)
		customAssestAsBytes, _ := json.Marshal(customAssest[i])
		APIstub.PutState(strconv.Itoa(i+1), customAssestAsBytes)
		fmt.Println("Added", customAssestAsBytes[i])
		i = i + 1
	}
...
This method does not take any arguments. Returns JSON string containing results. 
 */
 func (s *SmartContract) queryAllCustomAsset(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	fmt.Printf("- queryAllCustomAsset:\n%s\n", buffer.String())
